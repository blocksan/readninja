    ...
    angular.module("textAngular.factories", []).factory("taBrowserTag", [function() {
        ...
        var a = {
            ...
            getByAttribute: function(b, c) {
                var d = [],
                    e = b.children();
                return e.length && angular.forEach(e, function(b) { d = d.concat(a.getByAttribute(angular.element(b), c)) }), void 0 !== b.attr(c) && d.push(b), d
            },
        ...
        return {
            ...
            link: function(a, b, c, d) {
                ...
                c.$observe("taMaxText", function(a) {
                    ...
                    d.$dirty && d.$validate()
                }), d.$validators.taMaxText = function(a) { var b = angular.element("<div/>"); return b.html(a), b.text().length <= e }
            }
        }
        ...
        return {
            ...
            link: function(a, b, c, d) {
                ...
                c.$observe("taMinText", function(a) {
                    ...
                    d.$dirty && d.$validate()
                }), d.$validators.taMinText = function(a) { var b = angular.element("<div/>"); return b.html(a), !b.text().length || b.text().length >= e }
            }
        }
            ...
            link: function(f, r, u, v) {
                ...
                if (
                    ...
                    if (f.events = {}, D) {
                        ...
                        r.on("focus", f.events.focus = function() { G = !0, r.removeClass("placeholder-text"), _() }), r.on("mouseup", f.events.mouseup = function() {
    ...
    return u.config([function() {
        ...
        return {
                            ...
                            return (e.ctrlKey || e.metaKey || e.specialKey) && angular.forEach(b, function(b, g) {
                                if (b.commandKeyCode && (b.commandKeyCode === e.which || b.commandKeyCode === e.specialKey))
                                    for (var h = 0; h < j[c].toolbarScopes.length; h++)
                                        if (void 0 !== j[c].toolbarScopes[h].tools[g]) { a.call(j[c].toolbarScopes[h].tools[g], d), f = !0; break }
                            }), f
                        },
            ...
            retrieveToolbarsViaEditor: function(a) {
                var b = [],
                    c = this;
                return angular.forEach(this.retrieveEditor(a).toolbars, function(a) { b.push(c.retrieveToolbar(a)) }), b
            },
            ...
            removeTool: function(a) {
                delete b[a], angular.forEach(i, function(b) {
                    ...
                    for (var c = 0; c < b.toolbar.length; c++) {
                        for (var d, e = 0; e < b.toolbar[c].length; e++) { if (b.toolbar[c][e] === a) { d = { group: c, index: e }; break } if (void 0 !== d) break }
        ...
        return {
            ...
            link: function(g, h, i) {
                ...
                angular.forEach(g.toolbar, function(a) {
                    ...
                    }, b.registerToolbar(g), g.$on("$destroy", function() { b.unregisterToolbar(g.name) })
            }
        }
